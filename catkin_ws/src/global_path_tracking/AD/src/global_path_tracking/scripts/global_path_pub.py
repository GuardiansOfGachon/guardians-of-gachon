...
class global_path_pub :
    def __init__(self, pkg_name = 'global_path_tracking', path_name = 'kcity'):
        ...
        # 이후 읽기 모드로 연다.
        full_path = '/home/vip/catkin_ws/src/global_path_tracking/AD/src/global_path_tracking/path/gcu_global_path.txt'
        # print(full_path)
